    ...
    <Section id="skills" title="Skills & Expertise">
        ...
        {skillCategories.map((category, index) => (
          <Card key={index} className="text-center">
            <div className="flex justify-center mb-4">
              <div
                className={`p-4 rounded-full bg-gray-100 dark:bg-gray-700 ${category.color}`}
              >
      ...
      <div className="mt-16 text-center">
        <Card className="max-w-4xl mx-auto">
          ...
          <p
            className={`${typography.bodySize} ${textColor} leading-relaxed font-semibold`}
          >
            Technology is constantly evolving, and I&apos;m passionate about
            staying up-to-date with the latest trends and best practices. I
            regularly explore new frameworks, attend conferences, and contribute
            to open-source projects to continuously improve my skills and
            knowledge.
          </p>
        </Card>
      </div>
